...
const lightElement = document.getElementById("ilaw");
  ...
  if (user) {
    ...
    chartRef.on('value', snapshot =>{
      ...
      dbRef.orderByKey().limitToLast(chartRange).on('child_added', snapshot =>{
        var jsonData = snapshot.toJSON(); // example: {temperature: 25.02, humidity: 50.20, light : 1008.48, timestamp:1641317355}
